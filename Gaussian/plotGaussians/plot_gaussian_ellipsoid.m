function h = plot_gaussian_ellipsoid(m, C, sdwidth, npts, axh,alphaChannel,color)
...
%set(h,'color',color);
%else
h = patchline(bp(1,:),bp(2,:),'linestyle','-','edgealpha',1,'edgecolor',color,'LineSmoothing','on','LineWidth',1.5);
%end
